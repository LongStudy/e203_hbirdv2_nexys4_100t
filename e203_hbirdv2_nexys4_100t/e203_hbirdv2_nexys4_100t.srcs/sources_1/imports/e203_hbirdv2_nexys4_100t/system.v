...
(
  ...
  input wire all_rst,//all_rst for fpga_rst and mcu_rst; Press: Low level

  // Dedicated QSPI interface
  output wire qspi0_cs,
  //output wire qspi0_sck, // remove to STARTUPE2
  ...
  // model select
  assign dut_io_pads_bootrom_n_i_ival  = 1'b1;   // 1 in FLASH 0 in BRAM
